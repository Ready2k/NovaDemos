...
exports.generateHandoffTools = generateHandoffTools;
exports.isHandoffTool = isHandoffTool;
exports.getTargetAgentFromTool = getTargetAgentFromTool;
exports.getPersonaIdForAgent = getPersonaIdForAgent;
/**
 * Generate handoff tools for agent-to-agent transfers
 */
function generateHandoffTools() {
    return [
        {
            toolSpec: {
 ...
 */
function getTargetAgentFromTool(toolName) {
 ...
 */
function getPersonaIdForAgent(agentName) {
    const mapping = {
