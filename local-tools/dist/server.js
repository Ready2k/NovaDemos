...
async function callAgentCoreGateway(toolName, input, gatewayTarget) {
...
function getMockData(toolName, input) {
...
function executeStringFormatter(input) {
...
function executeDateFormatter(input) {
